...
const AdminRestaurantCard = ({ restaurant }: Props) => {
    ...
    const toggleStatus = async (
        ...
        const nextStatus: Restaurant["status"] =
        ...
        try {
            const result = await serverFetch(
                `/api/admin/update/restaurant/${id}`,
                "PATCH",
                {
                    status: nextStatus,
                }
            ...
            if (result.modifiedCount > 0) {
                toast.success(`Restaurant is now ${nextStatus} 🎉`);
                router.refresh();
            } else {
                    ...
                    <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex justify-between gap-2.5">
                            ...
                            <button
                                ...
                                className={`btn capitalize ${restaurant.status === "approved"
                                        ? "btn-success"
