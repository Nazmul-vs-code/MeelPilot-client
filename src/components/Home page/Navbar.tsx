...
const Navbar = () => {
    ...
    // Fixed: Tell TypeScript that user might contain a custom 'role' property
    ...
    const userMenu = (
        <div className="dropdown dropdown-end">
            ...
            >
                <li>
                    {/* Fixed: Access role safely from the casted user object */}
                    <Link href={`/dashboard/${user?.role ?? "buyer"}`}>
                        <FcHome />  Dashboard
                    </Link>
                </li>
